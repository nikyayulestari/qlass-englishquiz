                    ...
                    <div class="features-item" style="text-align: left;">
                        <div class="features-icon">
                            <h4 style="font-size: 16px; margin-bottom: 5px;">{{$isian->tnyIsian}}</h4>
                                ...
                                ?>
                                @if($jumlah>0)
                                <p style="font-size: 12px;"><a href="#" data-toggle="modal" data-target="#downloadFile{{$isian->idIsian}}"><i class="fa fa-paperclip" aria-hidden="true"></i> {{$jumlah}} attachments</a></p>
                                @endif
                            
                            <p style="margin-top: 15px;"><div class="custom-file">
                                <input type="file" class="form-control-file" name="nmFile" id="nmFile" style="font-size: 12px;"></div>
                            </p>
                        </div>
                    </div>
                </div>
