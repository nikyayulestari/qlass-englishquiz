...
<head>
    ...
    <title>Qlass - Register as a Student</title>
<!--
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="contact-form">
                            <form id="contact" action="/murid/create" method="post">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <fieldset>
                                            <input name="nmMurid" type="text" placeholder="Full Name" required=""
                                                style="background-color: rgba(250,250,250,0.3);">
                                        </fieldset>
                                    </div>
                                    <div class="col-md-12 col-sm-12">
                                        <fieldset>
                                            <input name="pwdMurid" type="password" placeholder="Password" required=""
                                                style="background-color: rgba(250,250,250,0.3);">
                                        </fieldset>
                                        <p class="teks">Have an account? <a href="/login">Login</a></p>
                                    </div>
                                    <div class="col-lg-12">
                                        <fieldset>
