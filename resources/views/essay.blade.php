...
<body>
                    ...
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="#" class="menu-item" data-toggle="modal" data-target="#createessay">Create Question</a></li>
    ...
    <!-- ***** Modal Create Essay Start ***** -->
    <div class="modal fade" id="createessay" tabindex="-1" role="dialog" aria-labelledby="CreateEssayTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="CreateEssayTitle">Create Question</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="/createessay" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                    <div class="modal-body">
                        <p>
                            <input type="textarea" class="form-control" name="tnyIsian" id="tnyIsian" placeholder="Question" required="" style="font-size: 14px;">
                            @if ($soal->judulSoal == 'Arrangement')
                            <p style="font-size: 12px;">Example Question : I - always - will - be - prepared</p>
                            @endif
                        </p>
                        <p  style="margin-top: 10px;">
                            @if ($soal->judulSoal == 'Essay')
                            <input type="textarea" class="form-control" name="benarIsian" id="benarIsian" placeholder="Correct Answer (Skip for manual correction)" style="font-size: 14px;">
                            @elseif ($soal->judulSoal == 'Arrangement')
                            <input type="textarea" class="form-control" name="benarIsian" id="benarIsian" placeholder="Correct Answer" style="font-size: 14px;" required="">
                            <p style="font-size: 12px;">Correct Answer : I will always be prepared</p>
                            @endif
                        </p>
                        <p style="margin-top: 10px;">
                    ...
                    <div class="features-item" style="text-align: left;">
                        <div class="features-icon">
                            <h4 style="font-size: 16px;">{{$isian->tnyIsian}}
                                @if (!empty($isian->benarIsian))
                                <p  style="font-size: 12px;">Correct Answer <b>{{$isian->benarIsian}}</b></p>
                                @else
                                <p  style="font-size: 12px;">Manual Correction</b></p>
                                @endif
                            </h4>
                            <?php
                            ...
                            ?>
                            @if($jumlah>0)
                            <p style="margin-top: 15px;"><a href="#" data-toggle="modal" data-target="#hapusFile{{$isian->idIsian}}" style="font-size: 12px;;"><i class="fa fa-paperclip" aria-hidden="true"></i> {{$jumlah}} attachments</a></p>
                            @endif
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p style="margin-top: 10px;">
                            @if ($soal->judulSoal == 'Essay')
                            <input type="text" class="form-control" name="benarIsian" id="benarIsian" required="" style="font-size: 14px;" value="{{$isian->benarIsian}}">
                            @elseif ($soal->judulSoal == 'Arrangement')
                            <input type="text" class="form-control" name="benarIsian" id="benarIsian" required="" style="font-size: 14px;" value="{{$isian->benarIsian}}" required="">
                            <p style="font-size: 12px;">Correct Answer : I will always be prepared</p>
                            @endif
                        </p>
                        <p style="margin-top: 10px;">
