...
<head>
    ...
    <title>Qlass - Student's Dashboard</title>
<!--
...
<body>
                    ...
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="#" class="menu-item" data-toggle="modal" data-target="#enrollclass">Enroll New Class</a></li>
    ...
    <!-- ***** Modal Masuk Start ***** -->
    <div class="modal fade" id="enrollclass" tabindex="-1" role="dialog" aria-labelledby="EnrollClassTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="EnrollClassTitle">Enroll a New Class</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="/enrollclass" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="form-group col-lg-12">
                                <input type="text" class="form-control" name="kodeKelas" id="kodeKelas" placeholder="Class Code" required="" style="font-size: 14px;">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Cancel</button>
                        <button type="submit" id="form-submit" class="btn btn-outline-primary">Submit</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <section class="section" id="about">
        <div class="container">
            <div class="row">
                @foreach($data_keanggotaan as $anggota)
                <?php
                $kelas = $data_kelas->find($anggota->idKelas); ?>
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"
                    ...
                    <div class="features-item" style="text-align: left;">
                        <div class="features-icon">
                            ...
                            <a href="/dashmurid/{{$kelas->idKelas}}" class="main-button">
                                Get In
                            </a>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="editaccount" tabindex="-1" role="dialog" aria-labelledby="editAccount" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="/dashmurid/updateaccount" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="form-group col-lg-12">
                                <input type="text" class="form-control" name="nmMurid" id="nmMurid" value="{{$murid->nmMurid}}" required="" style="font-size: 14px;">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal fade" id="editpass" tabindex="-1" role="dialog" aria-labelledby="editPass" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="/dashmurid/updatepass" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="form-group col-lg-12">
